...
@section('main-area')
							...
							<div class="tab-pane active" id="tab_0">
								...
								<div class="portlet box green">
                                						...
                                						<div class="portlet-body form">
                                							<!-- BEGIN FORM-->
                                        {{ Form::open(array('url'=>'content/create', 'files'=>true,'class'=>'form-horizontal form-bordered')) }}
                                                    ...
                                                    <div class="form-body">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                          {{ Form::text('title', null, array('class'=>'form-control','placeholder'=>'نام مطللب خود را وارد نمایید')) }}
 ...
 <div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="maxlength_textarea" name="slug" class="form-control" maxlength="225" rows="2" placeholder="متن کوتاه در مورد مطلب شما"></textarea>
 ...
 <div class="form-group">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group last">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="ckeditor form-control" name="body" rows="6"></textarea>
                                            </div>
                                        </div>
                                    </div>
