...
<!-- BEGIN PAGE STYLES -->
{{ HTML::style('/assets/admin/pages/css/tasks-rtl.css') }}
<!-- END PAGE STYLES -->
<!-- BEGIN THEME STYLES -->
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<span class="title">ثبت محصولات</span>
               ...
               <li>
               					...
               					<ul class="sub-menu">
               						...
               						<li>
               							<a href="/admin/content/add">
               							افزودن محتوای جدید</a>
               						</li>
...
{{ HTML::script('/assets/admin/pages/scripts/ecommerce-products-edit.js') }}
