									...
									<div class="tab-content no-space">
											...
											<div class="form-body">
													...
													* </span>
													...
													<div class="col-md-10">
														<div class="form-control height-auto">
															...
															@foreach(Category::groupBy('name')->get() as $man)
																...
																{{--	{{ Form::label('category_id', 'Category') }}--}}
																		...
																		<label><input type="checkbox" name="product[categories][]" value="1">{{$man->name}}</label>
																			</li>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control input-medium" name="product[price]" placeholder="">
													</div>
												</div>
										...
										<div class="tab-pane" id="tab_images">
											...
											<div id="tab_images_uploader_container" class="text-align-reverse margin-bottom-10">
												...
												<a id="tab_images_uploader_uploadfiles" href="javascript:loadfile;"  onchange="loadfile(this)" class="btn green">
